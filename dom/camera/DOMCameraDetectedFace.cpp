...
JSObject*
DOMCameraPoint::WrapObject(JSContext* aCx, JS::Handle<JSObject*> aScope)
{
  return CameraPointBinding::Wrap(aCx, aScope, this);
}

JSObject*
DOMCameraDetectedFace::WrapObject(JSContext* aCx, JS::Handle<JSObject*> aScope)
{
  return CameraDetectedFaceBinding::Wrap(aCx, aScope, this);
}
